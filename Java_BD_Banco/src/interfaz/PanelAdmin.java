...
public class PanelAdmin extends JPanel {
	...
	public PanelAdmin() {
		...
		gbc_listNombreTablas.gridx = 2;
		gbc_listNombreTablas.gridy = 0;
		...
		gbc_listAtributosTabla.gridx = 2;
		gbc_listAtributosTabla.gridy = 1;
